...
import twitterIcon from "../assets/twitter_icon.png"; // New icon
import instagramIcon from "../assets/instagram_icon.png"; // New icon
import whatsappIcon from "../assets/whatsapp_icon.png"; // New icon
...
export default function GameTaskPage() {
  ...
  const shareToWhatsApp = useCallback(() => {
    ...
    const text = `I ranked #${userRank.rank} with a score of ${userRank.score} on the Indomie HOH game! 🏆 Join the challenge: ${window.location.origin} #IndomieHOH`;
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div className="flex flex-col items-center min-h-screen py-6">
              ...
              <div className="mt-6 flex gap-4">
                ...
                <button
                  onClick={handleShare}
                  className="text-yellow-400 font-bold text-lg px-8 py-3 rounded-xl shadow-md"
                >
